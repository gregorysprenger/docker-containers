...
class TestControls(unittest.TestCase):
    ...
    def test_python_checksum(self):
        ...
        self.assertEqual(python_checksum, "866789e903d1a0ea9f5666033e7ec3c6b3227d3d70e786400b1e1bc357f11f57")
    ...
    def test_python3_output_checksum(self):
        ...
        self.assertEqual(python3_output_checksum, "99252d6ba98f31d4db4c4d54a64a052f03961035d0d22039c5ddacd73f4ef187")
    ...
    def test_biopython_misprint_checksum(self):
        ...
        self.assertEqual(biopython_misprint_checksum, "da993c34273dcfc6429b3eba1a8cb12c79bbd7c9660075a2d45839b8fa5ef107")
