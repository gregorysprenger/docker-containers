...
def test_positive_controls(capsys):
    ...
    assert cgst_checksum == "f7c03c7ec44ce1dca23dadc01f7d41a42da90940f34d4241ad86f0cd5f19fc55"

    # Test summary output
    with open("pos_controls/test_summary.tsv.checksum") as f:
        summary_checksum = f.readlines()[0].split(" ")[0]
    assert summary_checksum == "43853c7930be69c560a6e08d3a10bcdfbb66aa47d56a21979f0bb1f9bde66f62"
